...
namespace HoTroBenhNhan.Data
{
    ...
    public partial class DulieuhientangEntities : DbContext
    {
        public DulieuhientangEntities()
            : base("name=DulieuhientangEntities")
        {
        }
        ...
        public virtual DbSet<Thongtinhientang> Thongtinhientang { get; set; }
        public virtual DbSet<TinhThanhPho> TinhThanhPho { get; set; }
        public virtual DbSet<Trinhtangbenh> Trinhtangbenh { get; set; }
